# JavaUnits (com.putridparrot.units)

[![Build](https://github.com/putridparrot/JavaUnits/actions/workflows/build.yaml/badge.svg)](https://github.com/putridparrot/JavaUnits/actions/workflows/build.yaml)
...
[![GitHub Releases](https://img.shields.io/github/release/putridparrot/JavaUnits.svg)](https://github.com/putridparrot/JavaUnits/releases)
[![GitHub Issues](https://img.shields.io/github/issues/putridparrot/JavaUnits.svg)](https://github.com/putridparrot/JavaUnits/issues)
...
```
import com.putridparrot.units;

System.out.println(Temperature.Celsius.toFahrenheit(12.0));
```
